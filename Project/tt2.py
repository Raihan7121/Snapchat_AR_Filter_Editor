# -*- coding: utf-8 -*-
"""
Created on Sat Oct 18 13:49:23 2025
...
img = cv2.imread(r"C:/Users/Acer/Desktop/imagelab/Project/Project/test/t1.jpg")
...
def editor_dashboard(file_name):
    image = cv2.imread("C:/Users/Acer/Desktop/imagelab/Snapchat-AR-Filter-main/Snapchat-AR-Filter-main/train/img.png", cv2.IMREAD_COLOR)
    print(f'''
...
def main_dashboard():
    ...
    if option == '1':
        ...
        if output_image is not None:
            ...
            print('No o1peration is applied in the image!')
    elif option == '3':
        output_image = editor_dashboard(file_name)
    elif option == '4':
        sys.exit(0)
